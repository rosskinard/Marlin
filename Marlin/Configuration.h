...
#define STRING_CONFIG_H_AUTHOR "(rkinard, E3-400XL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3 400XL 6/15/20"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 - Micro Swiss All Metal MK8 Hotend
  // from pidautotune (M303  C5 E0 S205)
  #define DEFAULT_Kp 57.09
  #define DEFAULT_Ki 7.49
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //120V 600W silicone heater into 4mm Creality 400x400 borosilicate
  //from pidautotune (M303 C5 E-1 S90)
  #define DEFAULT_bedKp 33.22
  #define DEFAULT_bedKi 1.47
  #define DEFAULT_bedKd 498.93
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 500, 20000 }
...
#define X_BED_SIZE 408
#define Y_BED_SIZE 408
